...
import { Settings, User, Lock, Trash2, AlertTriangle, Check, Eye, EyeOff } from 'lucide-react'
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                onClick={() => {
                  // Account deletion would log out and call DELETE /api/v1/users/me
                  // Placeholder — implement when backend endpoint exists
                  alert('Account deletion endpoint not yet wired up.')
                }}
              >
    ...
    <div className="bg-white dark:bg-gray-900 sm:rounded-xl sm:border sm:border-gray-200 dark:sm:border-gray-800 overflow-hidden">
      ...
      <div className="flex">
        ...
        <nav
          ...
          className="flex flex-col gap-1 p-3 border-r border-gray-100 dark:border-gray-800 w-36 shrink-0"
        >
