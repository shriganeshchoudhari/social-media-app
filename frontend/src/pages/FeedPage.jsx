  ...
  return (
    <div className="bg-white dark:bg-gray-900 sm:rounded-xl sm:border sm:border-gray-200 dark:sm:border-gray-800 overflow-hidden">
      ...
      <div className="sticky top-0 z-10 bg-white/95 dark:bg-gray-900/95 backdrop-blur border-b border-gray-200 dark:border-gray-800 px-4 py-3">
        <h1 className="text-lg font-bold text-gray-900 dark:text-gray-100">Home</h1>
      </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center py-16 gap-3 text-center px-4">
          ...
          <p className="text-lg font-semibold text-gray-800 dark:text-gray-200">Your feed is empty</p>
          <p className="text-sm text-gray-500 dark:text-gray-400">Follow people to see their posts here, or share your first post above!</p>
        </div>
      ) : (
        <>
          {posts.map(post => (
