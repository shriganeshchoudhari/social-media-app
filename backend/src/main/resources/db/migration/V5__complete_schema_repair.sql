-- ============================================================
-- V5 — Complete schema repair & ensure
-- Idempotent: safe to run against any partial or complete schema.
-- Guarantees every table, column, constraint, and index exists.
-- ============================================================
...
-- ============================================================
-- TABLES  (CREATE TABLE IF NOT EXISTS covers every possible
--          state: never created, partially created, etc.)
-- ============================================================
...
-- role column added in V4; add it here too in case V4 never ran
...
-- ============================================================
-- INDEXES  (IF NOT EXISTS prevents duplicate-index errors)
-- ============================================================
