 ...
 *
 * The seeder is idempotent — it skips seeding if the "alice" user already
 * exists.
 *
...
public class DataSeeder implements ApplicationRunner {
        ...
        public void run(ApplicationArguments args) {
                ...
                // ── 3. Posts ─────────────────────────────────────────
                Post p1 = savePost(alice, "Hello ConnectHub! 👋 Excited to join this platform. #intro #hello",
                                Post.Privacy.PUBLIC);
                Post p2 = savePost(alice,
                                "Just finished reading 'Alice in Wonderland' again. Some things never get old 📚 #books #reading",
                                Post.Privacy.PUBLIC);
                Post p3 = savePost(bob,
                                "Built my first standing desk today! Productivity through the roof 🔨 #diy #productivity",
                                Post.Privacy.PUBLIC);
                Post p4 = savePost(bob,
                                "Coffee ☕ + code = perfect morning. What's your morning routine? #coding #coffee",
                                Post.Privacy.PUBLIC);
                Post p5 = savePost(carol,
                                "Just watched the most amazing meteor shower last night 🌠 #space #stargazing",
                                Post.Privacy.PUBLIC);
                savePost(carol, "Training update: 10km run in 48 minutes! New personal best 🏃‍♀️ #fitness #running",
                                Post.Privacy.FOLLOWERS_ONLY);
                Post p7 = savePost(dave, "New drum cover dropping this weekend 🥁 Stay tuned! #music #drums",
                                Post.Privacy.PUBLIC);
                Post p8 = savePost(eve,
                                "The universe is 13.8 billion years old and I still can't find my keys 😂 #space #relatable",
                                Post.Privacy.PUBLIC);
                Post p9 = savePost(alice,
                                "Pro tip: name your variables properly. Future you will thank you 💡 #coding #tips",
                                Post.Privacy.PUBLIC);
                Post p10 = savePost(bob, "Weekend project done! Built a bird feeder from scratch 🐦 #diy #nature",
                                Post.Privacy.PUBLIC);

                // ── 4. Likes ─────────────────────────────────────────
                like(bob, p1);
                like(carol, p1);
                like(dave, p1); // alice's intro — 3 likes
                like(bob, p2);
                like(eve, p2); // alice's books — 2 likes
                like(alice, p3);
                like(carol, p3);
                like(eve, p3); // bob's desk — 3 likes
                like(alice, p4);
                like(carol, p4);
                like(dave, p4); // bob's coffee — 3 likes
                like(alice, p5);
                like(bob, p5);
                like(eve, p5); // carol's stars — 3 likes
                like(alice, p7);
                like(bob, p7); // dave's drums — 2 likes
                like(alice, p8);
                like(bob, p8);
                like(carol, p8); // eve's joke — 3 likes
                like(bob, p9);
                like(carol, p9);
                like(dave, p9); // alice's tip — 3 likes
                like(alice, p10);
                like(carol, p10); // bob's bird feeder — 2 likes
