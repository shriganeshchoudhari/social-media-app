...
- generic [ref=e3]:
  ...
  - main [ref=e54]:
    - generic [ref=e56]:
      - generic [ref=e58]:
        - img [ref=e59]
        - textbox "Search posts, users, hashtags…" [active] [ref=e62]: Builder
      - generic [ref=e63]:
        - button "Posts" [ref=e64] [cursor=pointer]
        - button "Users" [ref=e65] [cursor=pointer]
        - button "Hashtags" [ref=e66] [cursor=pointer]
      - generic [ref=e68]:
        - link "B" [ref=e69] [cursor=pointer]:
          - /url: /profile/bob
          - generic [ref=e70]: B
        - generic [ref=e71]:
          - link "Bob Builder @bob" [ref=e72] [cursor=pointer]:
            - /url: /profile/bob
            - paragraph [ref=e73]: Bob Builder
            - paragraph [ref=e74]: "@bob"
          - paragraph [ref=e75]: Can we fix it? Yes we can! 🔨
        - button "Follow" [ref=e76] [cursor=pointer]
  - button "Open Spark AI assistant" [ref=e77] [cursor=pointer]:
    - generic [ref=e78]: ⚡
    - generic [ref=e79]: Ask Spark
```